  ...
  const SUBJECTS = [
    {
      ...
      linchpin_url: 'https://linchpinedu.com/lectures/e270ea956b1c470392cc5b874027f88b',
      ...
      parts: [
        { part: 'PART 01', page: 4, title: '직류기초 & 옴·키르히호프', topics: ['1. 옴의 법칙', '2. 키르히호프의 법칙(KCL, KVL)', '3. 저항의 직·병렬 접속', '4. 휘스톤 브리지 평형조건'] },
        { part: 'PART 02', page: 6, title: '정현파 교류의 기초 표현', topics: ['5. 정현파교류 표현 및 위상', '6. 실횻값, 평균값, 파고율, 파형률'] },
        { part: 'PART 03', page: 7, title: '교류 RLC 회로 & 전력', topics: ['7. R-L-C 직렬 회로', '8. R-L-C 병렬 회로', '9. 교류 전력(유효·무효·피상)', '10. 인덕턴스의 가동·차동 접속'] },
        { part: 'PART 04', page: 9, title: '회로망 정리', topics: ['11. 전원변환', '12. 중첩의 정리', '13. 테브난의 정리 & 노턴 정리', '14. 밀만의 정리'] },
        { part: 'PART 05', page: 14, title: '대칭 3상 교류 & 결선', topics: ['15. 평형 3상 교류 기초', '16. Y 결선, 델타(Δ) 결선', '17. V 결선 (출력비 57.7%, 이용률 86.6%)'] },
        { part: 'PART 06', page: 16, title: '부하 변환 & 2전력계법', topics: ['18. 부하의 Y-Δ 변환', '19. 2전력계법 (전체 P = W₁ + W₂)'] },
        { part: 'PART 07', page: 18, title: '대칭좌표법 (불평형 3상)', topics: ['20. 대칭좌표법(영상, 정상, 역상분)', '21. 불평형률 계산'] },
        { part: 'PART 08', page: 19, title: '비정현파 푸리에 급수', topics: ['22. 비정현파의 푸리에 급수', '23. 파형의 대칭성', '24. 비정현파 전력', '25. 비정현파 임피던스'] },
        { part: 'PART 09', page: 22, title: '2단자망 해석', topics: ['26. 구동점 임피던스 함수', '27. 정저항 회로 조건', '28. 역회로 조건'] },
        { part: 'PART 10', page: 24, title: '4단자망 파라미터', topics: ['29. 4단자정수 기본식', '30. T형, π형 회로 정수', '31. 영상 파라미터'] },
        { part: 'PART 11', page: 26, title: '분포정수회로', topics: ['32. 특성임피던스 Z₀ 및 전파정수 γ'] },
        { part: 'PART 12', page: 27, title: '라플라스 변환 기초', topics: ['33. 기본함수 라플라스 변환'] },
        { part: 'PART 13', page: 28, title: '라플라스 정리 & 역변환', topics: ['34. 시간추이 정리', '35. 복소추이 정리', '36. 실미분/실적분 정리', '37. 초깃값/최종값 정리', '38. 역라플라스 변환 (헤비사이드)'] },
        { part: 'PART 14', page: 30, title: '과도현상 & 전달함수', topics: ['39. RL/RC 과도현상과 시정수', '40. 전기회로의 전달함수'] }
      ]
    },
    {
      id: 'control',
      ...
      parts: [
        { part: 'PART 01', page: 34, title: '폐회로 제어계 & 분류', topics: ['1. 폐회로 제어계의 구성 요소', '2. 자동제어계의 분류 (목표값, 제어량)'] },
        { part: 'PART 02', page: 35, title: '블록선도 & 메이슨 공식', topics: ['3. 블록선도 등가변환과 신호흐름선도'] },
        { part: 'PART 03', page: 38, title: '안정도 판별법 (루스)', topics: ['4. 특성방정식 → 루스(Routh) 안정도 판별'] },
        { part: 'PART 04', page: 41, title: '2차 지연 제어계', topics: ['5. 감쇠비 ζ에 따른 2차 과도응답 특성'] },
        { part: 'PART 05', page: 42, title: '과도응답 & 정상편차', topics: ['6. 입력 함수에 따른 과도응답', '7. 정상편차 상수 (위치, 속도, 가속도)'] },
        { part: 'PART 06', page: 43, title: '주파수 전달함수 & 보드선도', topics: ['8. 주파수 전달함수 G(jω)', '9. 벡터궤적 → 나이퀴스트 안정도', '10. 보드선도 이득여유와 위상여유'] },
        { part: 'PART 07', page: 45, title: '근궤적법 (Root Locus)', topics: ['11. 근궤적 영점과 극점', '12. 근궤적의 가지 수', '13. 점근선 교차점과 각도'] },
        { part: 'PART 08', page: 47, title: '상태공간법 & z변환', topics: ['14. 상태방정식과 시스템행렬 A', '15. 특성방정식 |sI - A| = 0', '16. 이산계 z 변환'] },
        { part: 'PART 09', page: 49, title: '시퀀스 제어 & 논리연산', topics: ['17. AND 게이트', '18. OR 게이트', '19. NOT 게이트', '20. 논리 대수 및 드모르간'] }
      ]
    },
    {
      id: 'em',
      ...
      parts: [
        { part: 'PART 01', page: 54, title: '벡터 & 쿨롱의 힘 & 전위', topics: ['1. 벡터 연산', '2. 쿨롱의 힘', '3. 전계의 세기', '4. 전기력선의 성질', '5. 전위와 전위경도'] },
        { part: 'PART 02', page: 60, title: '도체의 성질 & 가우스정리', topics: ['6. 도체의 일반 성질', '7. 가우스 정리', '8. 전속밀도'] },
        { part: 'PART 03', page: 63, title: '형상별 전계 & 전기쌍극자', topics: ['9. 가우스 법칙 해석(구/원통/평면)', '10. 전기 쌍극자'] },
        { part: 'PART 04', page: 67, title: '정전용량 & 콘덴서 연결', topics: ['11. 정전용량 공식', '12. 콘덴서 직·병렬 연결', '13. 도체계의 정전에너지 W=(1/2)CV²'] },
        { part: 'PART 05', page: 72, title: '유전체 & 경계조건', topics: ['14. 전기 분극의 세기 P', '15. 유전체 경계조건', '16. 맥스웰 응력', '17. 복합 유전체 용량', '18. 전기 영상법'] },
        { part: 'PART 06', page: 77, title: '전도전류 & 변위전류', topics: ['19. 전도전류 밀도', '20. 변위전류(유전체 내)', '21. 전기저항과 누설 콘덕턴스'] },
        { part: 'PART 07', page: 79, title: '자계 & 암페어 법칙', topics: ['22. 자하에 의한 자계', '23. 앙페르의 오른손 법칙', '24. 무한 직선전류의 자계', '25. 원형코일 자계'] },
        { part: 'PART 08', page: 83, title: '전자력 & 로렌츠의 힘', topics: ['26. 자계 내 도체가 받는 전자력 F=IBLsinθ', '27. 로렌츠의 힘 F=q(E + v×B)'] },
        { part: 'PART 09', page: 85, title: '자성체 & 자기이력곡선', topics: ['28. 자성체의 종류(강/상/반자성)', '29. 히스테리시스 곡선(잔류자기, 보자력)'] },
        { part: 'PART 10', page: 87, title: '자기회로', topics: ['30. 자기저항 Rm=l/(μS) 및 옴의 법칙'] },
        { part: 'PART 11', page: 88, title: '전자유도 & 표피효과', topics: ['31. 패러데이-렌츠 전자유도', '32. 움직이는 도체의 기전력 e=Blvsinθ', '33. 표피효과와 침투깊이'] },
        { part: 'PART 12', page: 91, title: '인덕턴스의 계산', topics: ['34. 자기인덕턴스 L', '35. 상호인덕턴스 M', '36. 결합계수 k'] },
        { part: 'PART 13', page: 94, title: '맥스웰 방정식 & 전자파', topics: ['37. 맥스웰 4대 기본 방정식', '38. 고유 임피던스(η₀ ≒ 377Ω)와 전파속도'] }
      ]
    },
    {
      id: 'emach',
      ...
      parts: [
        { part: 'PART 01~03', page: 100, title: '[직류기] 구조·발전기·전동기', topics: ['1. 기초원리 & 전기자 권선법', '2. 유기기전력 E=(pZ/60a)ΦN', '3. 전기자 반작용 & 정류', '4. 직류기 종류(타여자, 분권, 직권)', '5. 전동기 토크 & 속도제어 & 효율'] },
        { part: 'PART 04~06', page: 109, title: '[동기기] 구조·단락비·병렬운전', topics: ['6. 동기발전기 출력식', '7. 동기 임피던스 & 단락비 Ks', '8. 전압변동률', '9. 발전기 병렬운전 조건', '10. 동기전동기 V곡선(위상특성)'] },
        { part: 'PART 07~10', page: 116, title: '[변압기] 등가회로·결선·효율', topics: ['11. 권수비 & 환산 등가회로', '12. 무부하·단락 시험', '13. %임피던스 강하', '14. 3상 결선(Y-Δ, V-V)', '15. 변압기 손실과 최대효율 조건', '16. 단권변압기 & 보호계전기'] },
        { part: 'PART 11~13', page: 128, title: '[유도기] 슬립·토크·기동법', topics: ['17. 슬립 s=(Ns-N)/Ns & 등가회로', '18. 2차 전력변환 식', '19. 토크 특성 (T ∝ V²)', '20. 기동방법(전전압, Y-Δ, 기동보상기)', '21. 권선형 비례추이 & 속도제어'] },
        { part: 'PART 14~15', page: 135, title: '[정류기/특수기] 전력전자 & 서보', topics: ['22. 전력용 반도체 소자(SCR, TRIAC)', '23. 단상/3상 정류회로(반파, 전파)', '24. SCR 위상제어', '25. 서보모터 & 스텝모터'] }
      ]
    },
    {
      id: 'pe',
      ...
      parts: [
        { part: 'PART 01~02', page: 144, title: '전선로 구성 & 선로정수', topics: ['1. 전선로 구성과 이도(Dip)', '2. 복도체 특성 & 코로나 방지', '3. 인덕턴스 L & 정전용량 C', '4. 충전전류 및 충전용량'] },
        { part: 'PART 03~04', page: 152, title: '송전특성 & 역률개선', topics: ['5. 단거리/중거리/장거리 송전해석', '6. 전력손실 Pl ∝ 1/V²', '7. 역률개선과 전력용 콘덴서', '8. 조상설비와 분로리액터'] },
        { part: 'PART 05~07', page: 158, title: '고장계산 & 접지 & 피뢰기', topics: ['9. 3상 단락 & 1선 지락고장', '10. 접지방식 비교(소호리액터 vs 직접접지)', '11. 피뢰기(LA) 구비조건 & 가공지선'] },
        { part: 'PART 08~11', page: 166, title: '보호계전 & 배전계통', topics: ['12. 보호계전방식(비율차동, 거리계전기)', '13. 차단기 용량 & 단로기', '14. 배전계통(수용률, 부등률, 부하율)'] },
        { part: 'PART 12', page: 176, title: '발전공학 (수력·화력)', topics: ['15. 수력발전 출력식 P=9.8QHη', '16. 화력발전 열효율'] }
      ]
    },
    {
      id: 'er',
      ...
      parts: [
        { part: 'PART 01~03', page: 181, title: '전압구분 & 가공전선 & 보안공사', topics: ['1. KEC 전압 구분(저압/고압/특고압)', '2. 가공전선 지표상 높이 & 안전율', '3. 병가·공가 및 이격거리', '4. 보안공사(1종, 2종, 3종) & 풍압하중'] },
        { part: 'PART 04~06', page: 194, title: '옥내배선공사 & 접지 & 차단기', topics: ['5. 저압 옥내공사(금속관/합성수지관/덕트/트레이)', '6. 절연내력시험 전압(10분간)', '7. 과전류차단기 & 누전차단기(15mA/0.03초)'] },
        { part: 'PART 07~09', page: 201, title: '발변전소 계측 & 피뢰설비 & 철도', topics: ['8. 변압기 보호장치(비율차동, 브흐홀츠)', '9. 피뢰기 설치 의무 장소 4곳', '10. 풍력터빈 & 전기철도 설비'] }
      ]
    }
  ];
